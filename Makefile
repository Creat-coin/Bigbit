#############################################################################
# Makefile for building: BigBit-qt
# Generated by qmake (2.01a) (Qt 4.8.5) on: mar. 17. avr. 00:43:13 2018
# Project:  BigBit-qt.pro
# Template: app
# Command: c:/Qt/4.8.5/bin/qmake.exe USE_QRCODE=1 USE_UPNP=1 USE_IPV6=1 -o Makefile BigBit-qt.pro
#############################################################################
...
Makefile: BigBit-qt.pro  c:/Qt/4.8.5/mkspecs/default/qmake.conf c:/Qt/4.8.5/mkspecs/features/device_config.prf \
	...
	$(QMAKE) USE_QRCODE=1 USE_UPNP=1 USE_IPV6=1 -o Makefile BigBit-qt.pro
...
clean: release-clean debug-clean FORCE
	-$(DEL_FILE) C:/Users/johanna/Desktop/Creation-monnaie/scrypt/Bigbit/compile/src/leveldb/libleveldb.a;
	-$(DEL_FILE) cd
	-$(DEL_FILE) C:/Users/johanna/Desktop/Creation-monnaie/scrypt/Bigbit/compile/src/leveldb
	-$(DEL_FILE) ;
	-$(DEL_FILE) $(MAKE)
	-$(DEL_FILE) clean
...
C:/Users/johanna/Desktop/Creation-monnaie/scrypt/Bigbit/compile/src/leveldb/libleveldb.a: FORCE
