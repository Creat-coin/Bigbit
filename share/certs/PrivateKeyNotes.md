...
unlocked to sign the BigBit-Qt.app bundle.
...
allowing somebody to distribute a BigBit-Qt.app or bitcoin-qt-setup.exe with a valid
...
prevent the "agtber hose cryptography" threat (coercing Gavin to sign a bad binary
...
that the BigBit-qt.exe file inside the installer had not been tampered with.
