...
// Copyright (c) 2014-2015 The BigBit developers
...
uint256 hashGenesisBlock("0xf4d22a7e2feffd9f5e92e10e7e00c7aa6ea807feb27e670250e15d0c7d1c25bd");
uint256 hashGenesisScrypt("0xf4d22a7e2feffd9f5e92e10e7e00c7aa6ea807feb27e670250e15d0c7d1c25bd");
...
bool CTxOut::IsDust() const
{
    ...
    // so dust is a txout less than 54 uBGBT
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    if(nHeight == 20)  
    {
        nSubsidy = 50000000 * COIN; // pour la distributions de depart + premine dev
    }
	else if(nHeight < 35001)  
    {
        nSubsidy = 50 * COIN;
    }
    else if(nHeight < 90001)  
    {
        nSubsidy = 25 * COIN;
    }
...
bool CBlock::ConnectBlock(CValidationState &state, CBlockIndex* pindex, CCoinsViewCache &view, bool fJustCheck)
{
    ...
    int64 nBIP16SwitchTime = 5201838400;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xf4d22a7e2feffd9f5e92e10e7e00c7aa6ea807feb27e670250e15d0c7d1c25bd");
    }
...
void SetGenesisHash() {
        ...
        // Genesis block
        const char* pszTimestamp = "13/04/2018 Héritage de Johnny Hallyday premier arbitrage judiciaire";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("3497ba8c0fe0276272017f1a54873b7105cd6a828e974507495a54706e0ea1f78deb486d2bc3f4cef65c4f78190e51de33de5c724df7ba1a9d947a4c751a8ga784d") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1523606376;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2542006;
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        assert(block.hashMerkleRoot == uint256("0xec5e412869e943ac9bbaa4e69b86d77cf5326b393333f852e34c18bd3ada56b8"));
...
unsigned char pchMessageStart[4] = { 0xc1, 0xb3, 0xd3, 0xf1 };
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("BigBitMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("BigBitMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("BigBitMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("BigBit-miner");
    ...
    try { loop {
        ...
        printf("Running BigBitMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
